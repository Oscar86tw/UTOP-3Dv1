...
const STAGES = Object.freeze([
  ...
  {
    name: '3D與設備核心',
    url: '../runtime/showcase/runtime-v51344-drivable-vehicles.js?v=5.1.3.44-drivable-vehicles-sensors-20260830'
  },
  {
    name: 'Foundation健康檢查',
...
async function startShowcase() {
  ...
  updateStatus('V5.1.3.44 車輛駕駛與感應模擬 啟動中…');
  ...
  updateStatus('V5.1.3.44 車輛駕駛與感應模擬 系統準備就緒');
