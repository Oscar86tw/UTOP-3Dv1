...
const state={globalMovementLocked:false,globalLabelsVisible:true,items:[],wires:[],selectedId:null,next:1,pending:null,activeWires:new Set(),wireLevels:new Map(),activeTab:'properties'};
...
function startSignalAuto(item){
 // V5.1.3.30：自動功能代表「自動待命」，不是無限循環切換。
...
function renderInspector(){
 ...
 if(state.activeTab==='properties'){
   ...
   :i.type==='signal2way'?[['laneA','A向綠燈'],['laneB','B向綠燈'],['allGreen','全綠'],['auto','自動待命'],['reset','復歸']]
   :i.type==='signal3way'?[['laneA','A向綠燈'],['laneB','B向綠燈'],['laneC','C向綠燈'],['allGreen','全綠'],['auto','自動待命'],['reset','復歸']]
