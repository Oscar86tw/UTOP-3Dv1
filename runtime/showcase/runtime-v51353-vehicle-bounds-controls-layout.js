...
const DEFAULT_SCENE_BOUNDS=Object.freeze({
 minX:-7.4,
 maxX:7.4,
 // V5.1.3.53：場景已延長至 77.22m，車輛邊界同步使用道路半長 38.61m。
 minZ:-38.61,
 maxZ:38.61
});
...
asphaltTexture.repeat.set(5,27);
const road=new THREE.Mesh(
 new THREE.PlaneGeometry(8,27),
...
[-5.55,5.55].forEach(x=>{
 const sidewalk=new THREE.Mesh(
  new THREE.PlaneGeometry(2.7,27),
 ...
 const curb=new THREE.Mesh(
  new THREE.BoxGeometry(.22,.18,27),
...
grassTexture.repeat.set(2,27);
[-7.45,7.45].forEach(x=>{
 const grass=new THREE.Mesh(
  new THREE.PlaneGeometry(1.05,27),
