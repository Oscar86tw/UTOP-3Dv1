...
const STAGES = Object.freeze([
  ...
  {
    name: '3D與設備核心',
    url: '../runtime/showcase/runtime-v51345-realistic-vehicles.js?v=5.1.3.45-realistic-vehicles-direction-20260830'
  },
  {
    name: 'Foundation健康檢查',
...
async function startShowcase() {
  ...
  updateStatus('V5.1.3.45 車輛方向與外觀升級 啟動中…');
  ...
  updateStatus('V5.1.3.45 車輛方向與外觀升級 系統準備就緒');
